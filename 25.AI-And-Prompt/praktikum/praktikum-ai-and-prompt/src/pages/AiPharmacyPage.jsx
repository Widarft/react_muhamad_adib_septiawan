...
const AiPharmacyPage = () => {
  ...
  const saveHistory = (newHistory) => {
    ...
    localStorage.setItem("pharmacyHistory", JSON.stringify(newHistory));
  };
  ...
  const generateResponse = async (userPrompt, conversationHistory) => {
    try {
      ...
      const productDataString = JSON.stringify(drugs);

      const fullPrompt = `
      Kamu adalah AI untuk customer service dari apotek bernama Pharmacyku. Dan namamu adalah Pharma.
      Tugasmu adalah membantu user mengetahui produk-produk yang tersedia di apotek kami.
      Berikut adalah informasi produk yang tersedia:\n\n${productDataString}
      ...
      <div className="bg-white rounded-md shadow-lg">
        ...
        <div className="p-6 border rounded-t-md bg-blue-bg-hero border-gray-200">
          <h2 className="text-2xl text-center font-bold text-white-news">
            AI Assistant For Pharmacy Product
          </h2>
        </div>
        <div className="p-6 bg-white-news">
          ...
          <form onSubmit={handleSubmit} className="mb-6">
            <div className="flex gap-2">
              ...
              >
                {isLoading ? "Generating..." : "Ask Pharma"}
              </button>
            </div>
          </form>
